...
- [Funciones en python](./funciones.mdx)
- [Alcance de las variables](./alcance_variables.mdx)
- [Recursividad](./recursividad.mdx)
- [La función main](./funcion_main.md)
- [Listas en Python](./listas.mdx)
