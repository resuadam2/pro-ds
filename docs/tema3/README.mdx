...
- [Captura de excepciones en Python (bloques try-except y derivados)](./apuntes_y_ejemplos/try_except.mdx)
- [Tuplas en Python](./apuntes_y_ejemplos/tuplas.mdx)
- [Diccionarios en Python](./apuntes_y_ejemplos/diccionarios.mdx)
- [Conjuntos en Python](./apuntes_y_ejemplos/conjuntos.mdx)
- [Ejemplo usos de random en Python](./apuntes_y_ejemplos/uso_random.mdx)
