...
- [Captura de excepciones en Python (bloques try-except y derivados)](./1_try_except.mdx)
- [Tuplas en Python](./2_tuplas.mdx)
- [Diccionarios en Python](./3_diccionarios.mdx)
- [Conjuntos en Python](./4_conjuntos.mdx)
- [Ejemplo usos de random en Python](./uso_random.mdx)
