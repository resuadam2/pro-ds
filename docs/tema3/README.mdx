...
- [Captura de excepciones en Python (bloques try-except y derivados)](./Apuntes%20y%20Ejemplos/1_try_except.mdx)
- [Tuplas en Python](./Apuntes%20y%20Ejemplos/2_tuplas.mdx)
- [Diccionarios en Python](./Apuntes%20y%20Ejemplos/3_diccionarios.mdx)
- [Conjuntos en Python](./Apuntes%20y%20Ejemplos/4_conjuntos.mdx)
- [Ejemplo usos de random en Python](./Apuntes%20y%20Ejemplos/uso_random.mdx)
- [Ejemplo de una posible solución del examen - descarga directa](./solucionario/sol_examen_ud3.py)
...
<details>
  <summary>Ver solución</summary>
   <CodeBlock language="python" title="TicTacToe">
   {require('!!raw-loader!./solucionario/tictactoe.py').default}
   </CodeBlock>
</details>
...
:::note*Nota*:
En todos los ejercicios debe hacerse una captura de las posibles excepciones.
:::
...
<details>
  <summary>Ver soluciones del bloque de Control de Excepciones</summary>
   <CodeBlock language="python" title="Solución">
   {require('!!raw-loader!./solucionario/ejersExcepciones.py').default}
   </CodeBlock>
</details>
...
<details>
  <summary>Ver solucions del bloque de Tuplas</summary>
   <CodeBlock language="python" title="Solución">
   {require('!!raw-loader!./solucionario/ejersTuplas.py').default}
   </CodeBlock>
</details>
...
<details>
  <summary>Ver soluciones del bloque de Diccionarios</summary>
   <CodeBlock language="python" title="Solución">
   {require('!!raw-loader!./solucionario/ejersDiccionarios.py').default}
   </CodeBlock>
</details>
...
<details>
  <summary>Ver soluciones del bloque de Conjuntos</summary>
   <CodeBlock language="python" title="Solución">
   {require('!!raw-loader!./solucionario/ejersConjuntos.py').default}
   </CodeBlock>
</details>
