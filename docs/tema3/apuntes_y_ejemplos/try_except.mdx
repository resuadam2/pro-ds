...
[Control de excepciones en Python](https://youtu.be/81QtD-mX7y4?si=xyPLfsZ4ddlO_dmo)
:::

<iframe width="560" height="315" src="https://www.youtube.com/embed/81QtD-mX7y4?si=2ZJM7WGoeAgA4DJ7" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen>
</iframe>
...
## Bloque *try-except*
El bloque *try-except* se utiliza para controlar las excepciones que se producen durante la ejecución de un programa.
...
El bloque *try-except-else* se utiliza para controlar las excepciones que se producen durante la ejecución de un programa y ejecutar un código adicional si no se produce ninguna excepción.
...
:::
:::tip[IMPORTANTE]
Cuándo se capturan varias excepciones, se deben capturar primero las excepciones más específicas y luego las excepciones más generales.
...
El bloque *finally* se ejecuta al final del bloque *try-except*. 
...
Esto nos sirve para lanzar excepciones personalizadas en un programa o para lanzar excepciones en un código que no está dentro de un bloque *try-except* o en base a una condición.
:::
