...
[![Tuplas en Python](https://www.youtube.com/watch?v=FyjFKUR8ZzI&list=PLgqNF1r2jtYxuVoBoXA6AuzmXZHpC17UO&index=10)](https://www.youtube.com/watch?v=FyjFKUR8ZzI&list=PLgqNF1r2jtYxuVoBoXA6AuzmXZHpC17UO&index=10)
:::

Las tuplas son una estructura de datos similar a las listas, pero con la diferencia de que son inmutables, es decir, no se pueden modificar una vez creadas. 
...
## Conversiones entre listas, tuplas y cadenas
```python
