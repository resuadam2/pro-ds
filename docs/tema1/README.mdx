...
- [Estructuras básicas de programación](./estructuras_basicas.md)
- [Operadores básicos de Python](./operadores_basicos.md)
- [Las sentencias break y continue](./ejemplo_break_continue.md)
- [Funciones básicas con cadenas](./funciones_basicas_con_cadenas.md)
- [Comprobando tipos de datos](./comprobadores_tipos.md)
- [Ejercicio bucles y letras grandes - ejemplo "U"](./ejercicio_tipo_examen.mdx)
