...
- Introducción a Java
    - [Variables y estructuras básicas en Java](./Apuntes%20y%20Ejemplos/0_IntroJava.mdx)
    - [Métodos en Java - Funciones y parámetros](./Apuntes%20y%20Ejemplos/1_Metodos.mdx)
    - [Arrays en Java](./Apuntes%20y%20Ejemplos/2_ArraysJava.mdx)
    - [Strings en Java](./Apuntes%20y%20Ejemplos/3_StringsJava.mdx)
    - [Leer datos por consola y Control de Excepciones](./Apuntes%20y%20Ejemplos/4_InputTecladoJava.mdx)

- Programación Orientada a Objetos
     - [Introducción a la POO en Java](./Apuntes%20y%20Ejemplos/5_IntroPOO.mdx)
     - [ArrayList en Java](./Apuntes%20y%20Ejemplos/6_ArrayList.mdx)
     - [Random en Java](./Apuntes%20y%20Ejemplos/7_RandomsJava.mdx)
     - [Control de Excepciones en Java](./Apuntes%20y%20Ejemplos/8_ControlExcepciones.mdx)
     - [Enumerados en Java](./Apuntes%20y%20Ejemplos/10_Enumerados.mdx)
     
- Ejemplos
     - [Proyecto POO con interfaz CLI](./Apuntes%20y%20Ejemplos/9_ProyectoPOOCLI.mdx)
     - Simulacro examen | [Enunciado](./Apuntes%20y%20Ejemplos/enunciado_simulacro.pdf) | [Solución](https://github.com/resuadam2/GestionAlbumsPOO)
     - Examen T4 | [Enunciado](./solucionario/SolExamenTema4/Enunciado%20Examen%20Programación%20-%20Tema%204%20(POO).pdf) | [Solución - descarga directa](./solucionario/SolExamenTema4.zip)

## Enunciados ejercicios

::::warning[ADVERTENCIA para todos los ejercicios del tema]
Aunque el enunciado no lo diga de forma explícita, todos los ejercicios deben implementar las clases que se piden y, además de esta clase, otra clase `Main`. 

En esta clase `Main` se deben crear los objetos que se piden en el enunciado y probar todos los métodos que se piden.
:::info[Ojo]
Es posible que en algún ejercicio la clase ``Main`` ya tenga el código dado. En este caso, tan solo copia el código dado en tu clase `Main` y completa el código que falta.
:::
::::
...
<details>
  ...
  defaultValue="video"
  values={[
     {label: 'Solución en Vídeo', value: 'video'},
    {label: 'Libro.java', value: 'libro'},
    {label: 'Main.java', value: 'main'},
  ]}>
     <TabItem value="video">
<iframe width="560" height="315" src="https://www.youtube.com/embed/xAaRu5rU7Ck?si=A14Tm9JdYesqXnPA" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>     </TabItem>
     <TabItem value="libro">
          <CodeBlock language="java">
               {require('!!raw-loader!./solucionario/PROtema4ejer1/src/Libro.java').default}
          </CodeBlock>
     </TabItem>
     <TabItem value="main">
          <CodeBlock language="java">
               {require('!!raw-loader!./solucionario/PROtema4ejer1/src/Main.java').default}
          </CodeBlock>
     </TabItem>
  </Tabs>
</details>
...
Probar el programa con la siguiente clase ``Main``:
<CodeBlock language="java" title="Main para probar Cuenta.java">
     {require('!!raw-loader!./solucionario/PROtema4ejer2/src/Main.java').default}
</CodeBlock>
...
<details>
  ...
  values={[
    {label: 'Solución en Vídeo', value: 'video'},
    {label: 'Cuenta.java', value: 'cuenta'},
  ]}>
       <TabItem value="video">
          <iframe width="560" height="315" src="https://www.youtube.com/embed/Ec6rwkvee5g?si=q2CqyASqFW7ENlqU" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
     </TabItem>
     <TabItem value="cuenta">
          <CodeBlock language="java">
               {require('!!raw-loader!./solucionario/PROtema4ejer2/src/Cuenta.java').default}
          </CodeBlock>
     </TabItem>
     </Tabs>
</details>
...
<details>
  ...
  values={[
    {label: 'Contador.java', value: 'contador'},
    {label: 'Main.java', value: 'main'},
  ]}>
     <TabItem value="contador">
          <CodeBlock language="java">
               {require('!!raw-loader!./solucionario/PROtema4ejer3/src/Contador.java').default}
          </CodeBlock>
     </TabItem>
     <TabItem value="main">
          <CodeBlock language="java">
               {require('!!raw-loader!./solucionario/PROtema4ejer3/src/Main.java').default}
          </CodeBlock>
     </TabItem>
  </Tabs>
</details>
...
<details>
  ...
  values={[
     {label: 'Solución en Vídeo', value: 'video'},
    {label: 'Fraccion.java', value: 'fraccion'},
    {label: 'Main.java', value: 'main'},
  ]}>
     <TabItem value="video">
          <iframe width="560" height="315" src="https://www.youtube.com/embed/El3kx81t25c?si=TdBLBiCqP_bmKZCm" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
     </TabItem>
     <TabItem value="fraccion">
          <CodeBlock language="java">
               {require('!!raw-loader!./solucionario/PROtema4ejer4/src/Fraccion.java').default}
          </CodeBlock>
     </TabItem>
     <TabItem value="main">
          <CodeBlock language="java">
               {require('!!raw-loader!./solucionario/PROtema4ejer4/src/Main.java').default}
          </CodeBlock>
     </TabItem>
  </Tabs>
</details>
...
<details>
  ...
  values={[
    {label: 'Empleado.java', value: 'empleado'},
    {label: 'Main.java', value: 'main'},
  ]}>
     <TabItem value="empleado">
          <CodeBlock language="java">
               {require('!!raw-loader!./solucionario/PROtema4ejer5/src/Empleado.java').default}
          </CodeBlock>
     </TabItem>
     <TabItem value="main">
          <CodeBlock language="java">
               {require('!!raw-loader!./solucionario/PROtema4ejer5/src/Main.java').default}
          </CodeBlock>
     </TabItem>
  </Tabs>
</details>
...
<details>
  ...
  defaultValue="dni"
  values={[
    {label: 'DNI.java', value: 'dni'},
    {label: 'Main.java', value: 'main'},
  ]}>
     <TabItem value="dni">
          <CodeBlock language="java">
               {require('!!raw-loader!./solucionario/PROtema4ejer6/src/DNI.java').default}
          </CodeBlock>
     </TabItem>
     <TabItem value="main">
          <CodeBlock language="java">
               {require('!!raw-loader!./solucionario/PROtema4ejer6/src/Main.java').default}
          </CodeBlock>
     </TabItem>
  </Tabs>
</details>
...
<details>
  ...
  defaultValue="fecha"
  values={[
    {label: 'Fecha.java', value: 'fecha'},
    {label: 'Main.java', value: 'main'},
  ]}>
     <TabItem value="fecha">
          <CodeBlock language="java">
               {require('!!raw-loader!./solucionario/PROtema4ejer7/src/Fecha.java').default}
          </CodeBlock>
     </TabItem>
     <TabItem value="main">
          <CodeBlock language="java">
               {require('!!raw-loader!./solucionario/PROtema4ejer7/src/Main.java').default}
          </CodeBlock>
     </TabItem>
  </Tabs>
</details>
...
<details>
  ...
  values={[
     {label: 'Persona.java', value: 'persona'},
    {label: 'Fecha.java', value: 'fecha'},
    {label: 'Main.java', value: 'main'},
  ]}>
     <TabItem value="persona">
           <CodeBlock language="java">
                    {require('!!raw-loader!./solucionario/PROtema4ejer8/src/Persona.java').default}
           </CodeBlock>
     </TabItem>
     <TabItem value="fecha">
          <CodeBlock language="java">
               {require('!!raw-loader!./solucionario/PROtema4ejer8/src/Fecha.java').default}
          </CodeBlock>
     </TabItem>
     <TabItem value="main">
          <CodeBlock language="java">
               {require('!!raw-loader!./solucionario/PROtema4ejer8/src/Main.java').default}
          </CodeBlock>
     </TabItem>
  </Tabs>
</details>
...
<details>
  ...
  values={[
    {label: 'Main.java', value: 'main'},
    {label: 'Asiento.java', value: 'asiento'},
     {label: 'Espectador.java', value: 'espectador'},
     {label: 'Pelicula.java', value: 'pelicula'},
     {label: 'Cine.java', value: 'cine'},
     {label: 'Metodos.java', value: 'metodos'},
  ]}>
     <TabItem value="main">
          <CodeBlock language="java">
               {require('!!raw-loader!./solucionario/PROtema4ejer9/src/Main.java').default}
          </CodeBlock>
     </TabItem>
     <TabItem value="asiento">
          <CodeBlock language="java">
               {require('!!raw-loader!./solucionario/PROtema4ejer9/src/Asiento.java').default}
          </CodeBlock>
     </TabItem>
     <TabItem value="espectador">
          <CodeBlock language="java">
               {require('!!raw-loader!./solucionario/PROtema4ejer9/src/Espectador.java').default}
          </CodeBlock>
     </TabItem>
     <TabItem value="pelicula">
          <CodeBlock language="java">
               {require('!!raw-loader!./solucionario/PROtema4ejer9/src/Pelicula.java').default}
          </CodeBlock>
     </TabItem>
     <TabItem value="cine">
          <CodeBlock language="java">
               {require('!!raw-loader!./solucionario/PROtema4ejer9/src/Cine.java').default}
          </CodeBlock>
     </TabItem>
     <TabItem value="metodos">
          <CodeBlock language="java">
               {require('!!raw-loader!./solucionario/PROtema4ejer9/src/Metodos.java').default}
          </CodeBlock>
     </TabItem>
  </Tabs>
</details>
...
[Soluciones clase - Enlace de descarga directa](./soluciones_clase/EjerciciosTema4.zip)
